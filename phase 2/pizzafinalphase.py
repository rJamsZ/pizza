...
def generate_receipt_file(data_to_save):  
    f = open("receipt0001.txt", "a")
...
#    size_cost = calculate_final_ammount(number_of_toppings_asked_for,size_cost,toppings_price)
    ...
    #generate_receipt_file(data_to_save, type_of_file)

    final_order = display_order(pizza_size,total_cost)
    generate_receipt_file(final_order)
    print(final_order)
